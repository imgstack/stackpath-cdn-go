...
/* UpdateScopeRuleConfigurationParams contains all the parameters to send to the API endpoint
   for the update scope rule configuration operation.
...
// WithDefaults hydrates default values in the update scope rule configuration params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateScopeRuleConfigurationParams) WithDefaults() *UpdateScopeRuleConfigurationParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the update scope rule configuration params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UpdateScopeRuleConfigurationParams) SetDefaults() {
