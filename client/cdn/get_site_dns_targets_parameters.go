...
/* GetSiteDNSTargetsParams contains all the parameters to send to the API endpoint
   for the get site Dns targets operation.
...
// WithDefaults hydrates default values in the get site Dns targets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDNSTargetsParams) WithDefaults() *GetSiteDNSTargetsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site Dns targets params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteDNSTargetsParams) SetDefaults() {
