...
/* GetScopeOriginsParams contains all the parameters to send to the API endpoint
   for the get scope origins operation.
...
// WithDefaults hydrates default values in the get scope origins params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetScopeOriginsParams) WithDefaults() *GetScopeOriginsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get scope origins params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetScopeOriginsParams) SetDefaults() {
