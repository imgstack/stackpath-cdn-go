...
/* GetSiteScriptParams contains all the parameters to send to the API endpoint
   for the get site script operation.
...
// WithDefaults hydrates default values in the get site script params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteScriptParams) WithDefaults() *GetSiteScriptParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get site script params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSiteScriptParams) SetDefaults() {
