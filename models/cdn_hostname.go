...
// ContextValidate validates this cdn hostname based on context it is used
func (m *CdnHostname) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
