...
// ContextValidate validates this cdn update origin request based on context it is used
func (m *CdnUpdateOriginRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
