...
// ContextValidate validates this custconf receipt logs config based on context it is used
func (m *CustconfReceiptLogsConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
