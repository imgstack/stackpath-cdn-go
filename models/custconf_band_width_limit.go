...
// CustconfBandWidthLimit The pattern based bandwidth throttling policy allows you to limit the
...
type CustconfBandWidthLimit struct {
	...
	// String of values deliminated by a '|' character. These are pattern match
	// rules to use for applying rate limiting on requests.
	Rule string `json:"rule,omitempty"`

	// These are the intial bytes (ri) and the sustained rate (rs) query string
