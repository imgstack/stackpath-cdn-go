...
// ContextValidate validates this custconf flv pseudo streaming based on context it is used
func (m *CustconfFlvPseudoStreaming) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
