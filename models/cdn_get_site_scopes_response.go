...
// ContextValidate validate this cdn get site scopes response based on the context it is used
func (m *CdnGetSiteScopesResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetSiteScopesResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CdnGetSiteScopesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
