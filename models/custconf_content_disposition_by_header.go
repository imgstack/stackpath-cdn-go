...
// ContextValidate validate this custconf content disposition by header based on the context it is used
func (m *CustconfContentDispositionByHeader) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateDefaultType(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CustconfContentDispositionByHeader) contextValidateDefaultType(ctx context.Context, formats strfmt.Registry) error {

	if m.DefaultType != nil {
		if err := m.DefaultType.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("defaultType")
			}
			return err
