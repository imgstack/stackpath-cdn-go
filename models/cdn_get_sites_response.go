...
// ContextValidate validate this cdn get sites response based on the context it is used
func (m *CdnGetSitesResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetSitesResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CdnGetSitesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
