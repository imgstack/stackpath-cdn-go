...
// ContextValidate validate this cdn get metrics response based on the context it is used
func (m *CdnGetMetricsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetMetricsResponse) contextValidateSeries(ctx context.Context, formats strfmt.Registry) error {
