...
// ContextValidate validates this custconf response header based on context it is used
func (m *CustconfResponseHeader) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
