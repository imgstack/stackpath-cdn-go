...
// ContextValidate validates this custconf cache key modification based on context it is used
func (m *CustconfCacheKeyModification) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
