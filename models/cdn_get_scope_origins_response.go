...
// ContextValidate validate this cdn get scope origins response based on the context it is used
func (m *CdnGetScopeOriginsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetScopeOriginsResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CdnGetScopeOriginsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
