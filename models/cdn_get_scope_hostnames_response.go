...
// ContextValidate validate this cdn get scope hostnames response based on the context it is used
func (m *CdnGetScopeHostnamesResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetScopeHostnamesResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CdnGetScopeHostnamesResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
