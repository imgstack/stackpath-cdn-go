...
func (m *CdnGetPopsResponse) validatePageInfo(formats strfmt.Registry) error {
...
func (m *CdnGetPopsResponse) validateResults(formats strfmt.Registry) error {
...
// ContextValidate validate this cdn get pops response based on the context it is used
func (m *CdnGetPopsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetPopsResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CdnGetPopsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
