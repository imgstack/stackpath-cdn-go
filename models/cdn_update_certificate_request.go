...
// ContextValidate validates this cdn update certificate request based on context it is used
func (m *CdnUpdateCertificateRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
