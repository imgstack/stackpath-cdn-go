...
// ContextValidate validates this custconf origin pull host based on context it is used
func (m *CustconfOriginPullHost) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
