...
// ContextValidate validate this custconf band width rate limit units based on the context it is used
func (m *CustconfBandWidthRateLimitUnits) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateSustained(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CustconfBandWidthRateLimitUnits) contextValidateInitial(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CustconfBandWidthRateLimitUnits) contextValidateSustained(ctx context.Context, formats strfmt.Registry) error {

	if m.Sustained != nil {
		if err := m.Sustained.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sustained")
			}
			return err
