...
// CdnUpdateScopeConfigurationResponse cdn update scope configuration response
...
func (m *CdnUpdateScopeConfigurationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CdnUpdateScopeConfigurationResponse) UnmarshalBinary(b []byte) error {
	var res CdnUpdateScopeConfigurationResponse
