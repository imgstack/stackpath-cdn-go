...
func (m *CdnGetOriginsResponse) validatePageInfo(formats strfmt.Registry) error {
...
func (m *CdnGetOriginsResponse) validateResults(formats strfmt.Registry) error {
...
// ContextValidate validate this cdn get origins response based on the context it is used
func (m *CdnGetOriginsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CdnGetOriginsResponse) contextValidatePageInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CdnGetOriginsResponse) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
